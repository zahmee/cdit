...
## أنظمة متخصّصة أخرى (مستقلّة عن عائلة الصدارة)
- **نظام المحاسبة المالية** — قيود يومية مزدوجة، شجرة حسابات هرمية، دورات مالية، فروع، أرصدة افتتاحية، ميزان مراجعة، قائمة دخل، وميزانية عمومية، مع تصدير وطباعة. نظام محاسبي ناضج ومستقر يعمل فعلياً منذ أكثر من ٨ سنوات. مناسب للمنشآت والمكاتب المحاسبية.
- **رياض الجنة — منصة إدارة المساجد والخطباء** — نظام دعوي تنسيقي مخصّص: إدارة المحاضرات والدروس، تنسيق كلمات الصلوات بين المساجد، نظام قطاعات ومواقع ومشرفين، فترات تسجيل بالتقويم الهجري والميلادي، وبوابة عامة للفعاليات القريبة. مثال حيّ على قدرتنا في بناء أنظمة مخصّصة بالكامل لاحتياجات الجهة، ومناسب للقطاع الخيري والدعوي.
